...
define('_GM_MODIFYCOORDS',      'Modify your corrdinates');
...
define('_GM_SHORTMESSAGE',        'Short Message');
define('_GM_SHORTMESSAGE',      'Short message (100 Chars max.)');
define('_GM_SHOWHIDEONLINES',   'Show Hide All onlines');
define('_GM_SHOWHIDESPECIALS',  'Show Hide All specials');
define('_GM_SHOWHIDEUSERS',     'Show Hide All users');
define('_GM_SHOWUSERLIST',        'Show Users list in sidebar (beware of display if the list is long)');
